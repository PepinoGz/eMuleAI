...
namespace Kademlia
{
	...
	public:
		...
		static CRoutingZone* TryGetRoutingZone();
		static CKademliaUDPListener* TryGetUDPListener();
		...
		static void ProcessICMPUnreachable(uint32 uIP, uint16 uUDPPort); // Process ICMP unreachable events
	...
	private:
		static clock_t m_clkNextSearchJumpStart;
		...
		static time_t m_tNextFindServingBuddy;
