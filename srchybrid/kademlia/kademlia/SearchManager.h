...
namespace Kademlia
{
	...
	public:
		...
		static void ProcessUnreachableResponse(uint32 uFromIP, uint16 uFromPort); // Deal with unreachable contacts
	...
	public: // Needed for the relocation of the JumpStart call!!!
