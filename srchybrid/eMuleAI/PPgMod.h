...
protected:
	...
	HTREEITEM m_htiFileInspector;
	HTREEITEM m_htiFileInspectorDisable;
	HTREEITEM m_htiFileInspectorLogOnly;
	HTREEITEM m_htiFileInspectorDelete;
	HTREEITEM m_htiFileInspectorFake;
	HTREEITEM m_htiFileInspectorDRM;
	HTREEITEM m_htiFileInspectorCompressionThresholdToBypassZero;
	HTREEITEM m_htiFileInspectorCheckPeriod;
	HTREEITEM m_htiFileInspectorCompletedThreshold;
	HTREEITEM m_htiFileInspectorZeroPercentageThreshold;
	HTREEITEM m_htiFileInspectorCompressionThreshold;
	HTREEITEM m_htiFileInspectorBypassZeroPercentage;
	HTREEITEM m_htiFileInspectorInvalidExt;
	int m_iFileInspector;
	bool m_bFileInspectorFake;
	bool m_bFileInspectorDRM;
	bool m_bFileInspectorInvalidExt;
	int m_iFileInspectorCheckPeriod;
	int m_iFileInspectorCompletedThreshold;
	int m_iFileInspectorZeroPercentageThreshold;
	int m_iFileInspectorCompressionThreshold;
	bool m_bFileInspectorBypassZeroPercentage;
	int m_iFileInspectorCompressionThresholdToBypassZero;
