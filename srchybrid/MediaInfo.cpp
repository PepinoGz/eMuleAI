...
// START: Codecs from Windows SDK "mmreg.h" file
	{ 0x0000, EMPTY,						_T("Unknown") },
	{ 0x0001, _T("PCM"),					_T("Uncompressed") },
	{ 0x0002, _T("ADPCM"),					EMPTY },
	{ 0x0003, _T("IEEE_FLOAT"),				EMPTY },
	{ 0x0004, _T("VSELP"),					_T("Compaq Computer Corp.") },
	{ 0x0005, _T("IBM_CVSD"),				EMPTY },
	{ 0x0006, _T("ALAW"),					EMPTY },
	{ 0x0007, _T("MULAW"),					EMPTY },
	{ 0x0008, _T("DTS"),					_T("Digital Theater Systems") },
	{ 0x0009, _T("DRM"),					EMPTY },
	{ 0x000A, _T("WMAVOICE9"),				EMPTY },
	{ 0x000B, _T("WMAVOICE10"),				EMPTY },
	{ 0x0010, _T("OKI_ADPCM"),				EMPTY },
	{ 0x0011, _T("DVI_ADPCM"),				_T("Intel Corporation") },
	{ 0x0012, _T("MEDIASPACE_ADPCM"),		_T("Videologic") },
	{ 0x0013, _T("SIERRA_ADPCM"),			EMPTY },
	...
	{ 0x0017, _T("DIALOGIC_OKI_ADPCM"),		EMPTY },
	{ 0x0018, _T("MEDIAVISION_ADPCM"),		EMPTY },
	{ 0x0019, _T("CU_CODEC"),				_T("Hewlett-Packard Company") },
	{ 0x0020, _T("YAMAHA_ADPCM"),			EMPTY },
	{ 0x0021, _T("SONARC"),					_T("Speech Compression") },
	{ 0x0022, _T("DSPGROUP_TRUESPEECH"),	EMPTY },
	...
	{ 0x0030, _T("DOLBY_AC2"),				EMPTY },
	{ 0x0031, _T("GSM610"),					EMPTY },
	{ 0x0032, _T("MSNAUDIO"),				EMPTY },
	{ 0x0033, _T("ANTEX_ADPCME"),			EMPTY },
	{ 0x0034, _T("CONTROL_RES_VQLPC"),		EMPTY },
	{ 0x0035, _T("DIGIREAL"),				_T("DSP Solutions, Inc.") },
	{ 0x0036, _T("DIGIADPCM"),				_T("DSP Solutions, Inc.") },
	{ 0x0037, _T("CONTROL_RES_CR10"),		EMPTY },
	...
	{ 0x003B, _T("ROCKWELL_ADPCM"),			EMPTY },
	{ 0x003C, _T("ROCKWELL_DIGITALK"),		EMPTY },
	{ 0x003D, _T("XEBEC"),					EMPTY },
	{ 0x0040, _T("G721_ADPCM"),				_T("Antex Electronics Corporation") },
	{ 0x0041, _T("G728_CELP"),				_T("Antex Electronics Corporation") },
	{ 0x0042, _T("MSG723"),					EMPTY },
	...
	{ 0x0059, _T("LUCENT_G723"),			EMPTY },
	{ 0x0060, _T("CIRRUS"),					EMPTY },
	{ 0x0061, _T("ESPCM"),					_T("ESS Technology") },
	{ 0x0062, _T("VOXWARE"),				EMPTY },
	{ 0x0063, _T("CANOPUS_ATRAC"),			EMPTY },
	{ 0x0064, _T("G726_ADPCM"),				_T("APICOM") },
	{ 0x0065, _T("G722_ADPCM"),				_T("APICOM") },
	{ 0x0067, _T("DSAT_DISPLAY"),			EMPTY },
	{ 0x0069, _T("VOXWARE_BYTE_ALIGNED"),	EMPTY },
	{ 0x0070, _T("VOXWARE_AC8"),			EMPTY },
	{ 0x0071, _T("VOXWARE_AC10"),			EMPTY },
	{ 0x0072, _T("VOXWARE_AC16"),			EMPTY },
	{ 0x0073, _T("VOXWARE_AC20"),			EMPTY },
	{ 0x0074, _T("VOXWARE_RT24"),			EMPTY },
	{ 0x0075, _T("VOXWARE_RT29"),			EMPTY },
	{ 0x0076, _T("VOXWARE_RT29HW"),			EMPTY },
	{ 0x0077, _T("VOXWARE_VR12"),			EMPTY },
	{ 0x0078, _T("VOXWARE_VR18"),			EMPTY },
	{ 0x0079, _T("VOXWARE_TQ40"),			EMPTY },
	{ 0x0080, _T("SOFTSOUND"),				EMPTY },
	{ 0x0081, _T("VOXWARE_TQ60"),			EMPTY },
	{ 0x0082, _T("MSRT24"),					EMPTY },
	...
	{ 0x0089, _T("ONLIVE"),					EMPTY },
	{ 0x0091, _T("SBC24"),					_T("Siemens Business Communications Sys") },
	{ 0x0092, _T("DOLBY_AC3_SPDIF"),		_T("Sonic Foundry") },
	{ 0x0093, _T("MEDIASONIC_G723"),		EMPTY },
	{ 0x0094, _T("PROSODY_8KBPS"),			_T("Aculab plc") },
	{ 0x0097, _T("ZYXEL_ADPCM"),			EMPTY },
	{ 0x0098, _T("PHILIPS_LPCBB"),			EMPTY },
	{ 0x0099, _T("PACKED"),					_T("Studer Professional Audio AG") },
	{ 0x00A0, _T("MALDEN_PHONYTALK"),		EMPTY },
	{ 0x0100, _T("RHETOREX_ADPCM"),			EMPTY },
	{ 0x0101, _T("IRAT"),					_T("BeCubed Software Inc.") },
	{ 0x0111, _T("VIVO_G723"),				EMPTY },
	{ 0x0112, _T("VIVO_SIREN"),				EMPTY },
	{ 0x0123, _T("DIGITAL_G723"),			_T("Digital Equipment Corporation") },
	{ 0x0125, _T("SANYO_LD_ADPCM"),			EMPTY },
	{ 0x0130, _T("SIPROLAB_ACEPLNET"),		EMPTY },
	{ 0x0130, _T("SIPR"),					_T("Real Audio 4 (Sipro)") },
	{ 0x0131, _T("SIPROLAB_ACELP4800"),		EMPTY },
	{ 0x0132, _T("SIPROLAB_ACELP8V3"),		EMPTY },
	{ 0x0133, _T("SIPROLAB_G729"),			EMPTY },
	{ 0x0134, _T("SIPROLAB_G729A"),			EMPTY },
	{ 0x0135, _T("SIPROLAB_KELVIN"),		EMPTY },
	{ 0x0140, _T("G726ADPCM"),				_T("Dictaphone Corporation") },
	{ 0x0150, _T("QUALCOMM_PUREVOICE"),		EMPTY },
	{ 0x0151, _T("QUALCOMM_HALFRATE"),		EMPTY },
	...
	{ 0x0170, _T("UNISYS_NAP_ADPCM"),		EMPTY },
	{ 0x0171, _T("UNISYS_NAP_ULAW"),		EMPTY },
	{ 0x0172, _T("UNISYS_NAP_ALAW"),		EMPTY },
	{ 0x0173, _T("UNISYS_NAP_16K"),			EMPTY },
	{ 0x0200, _T("CREATIVE_ADPCM"),			EMPTY },
	{ 0x0202, _T("CREATIVE_FASTSPEECH8"),	EMPTY },
	{ 0x0203, _T("CREATIVE_FASTSPEECH10"),	EMPTY },
	{ 0x0210, _T("UHER_ADPCM"),				EMPTY },
	{ 0x0220, _T("QUARTERDECK"),			EMPTY },
	...
	{ 0x1400, _T("NORRIS"),					EMPTY },
	{ 0x1500, _T("SOUNDSPACE_MUSICOMPRESS"),_T("AT&T Labs, Inc.") },
	{ 0x1600, _T("MPEG_ADTS_AAC"),			EMPTY },
	{ 0x1601, _T("MPEG_RAW_AAC"),			EMPTY },
	{ 0x1608, _T("NOKIA_MPEG_ADTS_AAC"),	EMPTY },
	{ 0x1609, _T("NOKIA_MPEG_RAW_AAC"),		EMPTY },
	{ 0x160A, _T("VODAFONE_MPEG_ADTS_AAC"),	EMPTY },
	{ 0x160B, _T("VODAFONE_MPEG_RAW_AAC"),	EMPTY },
...
static CMapStringToString g_mapCodecDisplayName; // Global codec display-name cache to allow deterministic purge on shutdown

CString GetCodecDisplayName(const CString &strCodecId)
{
	CString strCodecDisplayName;
	if (g_mapCodecDisplayName.Lookup(strCodecId, strCodecDisplayName))
	...
	g_mapCodecDisplayName[strCodecId] = strCodecDisplayName;
	return strCodecDisplayName;
}

void ClearMediaInfoCaches()
{
	g_mapCodecDisplayName.RemoveAll(); // Release internal CPlex blocks used by the cache map before CRT leak snapshot
}
...
bool GetRIFFHeaders(LPCTSTR pszFileName, SMediaInfo *mi, bool &rbIsAVI, bool bFullInfo)
{
	...
	// Open AVI file
	int hAviFile = OpenCrtReadOnlyLongPath(pszFileName); // Use long-path aware CRT fd open
	if (hAviFile < 0)
		return false;
						...
						if (strmhdr.hdr.fccType == streamtypeAUDIO) {
							...
							if (mi->iAudioStreams == 1) {
								...
								if (bFullInfo && mi->strInfo.m_hWnd) {
									...
									mi->strInfo << GetResString(_T("AUDIO")) << _T(" #") << mi->iAudioStreams;
									if (strmhdr.nam && strmhdr.nam[0] != '\0')
										mi->strInfo << _T(": \"") << strmhdr.nam << _T("\"");
									mi->strInfo << _T("\n");
									if (strmhdr.fmt.wav && strmhdr.dwFormatLen >= sizeof *strmhdr.fmt.wav) {
										mi->strInfo << _T("   ") << GetResString(_T("CODEC")) << _T(":\t") << GetAudioFormatName(strmhdr.fmt.wav->wf.wFormatTag) << _T("\n");
										...
										if (strmhdr.fmt.wav->wf.nAvgBytesPerSec) {
											...
											if (strmhdr.fmt.wav->wf.nAvgBytesPerSec == _UI32_MAX)
												...
												strBitrate.Format(_T("%u %s"), (UINT)((strmhdr.fmt.wav->wf.nAvgBytesPerSec * 8 + 500) / 1000), (LPCTSTR)GetResString(_T("KBITSSEC")));
											mi->strInfo << _T("   ") << GetResString(_T("BITRATE")) << _T(":\t") << strBitrate << _T("\n");
										}

										if (strmhdr.fmt.wav->wf.nChannels) {
											mi->strInfo << _T("   ") << GetResString(_T("CHANNELS")) << _T(":\t");
										...
										if (strmhdr.fmt.wav->wf.nSamplesPerSec)
											mi->strInfo << _T("   ") << GetResString(_T("SAMPLERATE")) << _T(":\t") << strmhdr.fmt.wav->wf.nSamplesPerSec / 1000.0 << _T(" kHz\n");

										if (strmhdr.fmt.wav->wBitsPerSample)
											mi->strInfo << _T("   Bit/sample:\t") << strmhdr.fmt.wav->wBitsPerSample << _T(" Bit\n");
									}
									if (fLength)
										mi->strInfo << _T("   ") << GetResString(_T("LENGTH")) << _T(":\t") << SecToTimeLength((UINT)fLength) << _T("\n");
								}
							}
							...
							if (mi->iVideoStreams == 1) {
								...
								if (bFullInfo && mi->strInfo.m_hWnd) {
									...
									mi->OutputFileName();
									mi->strInfo.SetSelectionCharFormat(mi->strInfo.m_cfBold);
									mi->strInfo << GetResString(_T("VIDEO")) << _T(" #") << mi->iVideoStreams;
									if (strmhdr.nam && strmhdr.nam[0] != '\0')
										mi->strInfo << _T(": \"") << strmhdr.nam << _T("\"");
									mi->strInfo << _T("\n");
									if (strmhdr.fmt.bmi && strmhdr.dwFormatLen >= sizeof *strmhdr.fmt.bmi) {
								...
								while (ck.GetPosition() < ck.GetLength()) {
									...
									case mmioFOURCC('I', 'N', 'A', 'M'):
										if (bFullInfo && mi->strInfo.m_hWnd && !strValue.IsEmpty())
											mi->strInfo << _T("   ") << GetResString(_T("TITLE")) << _T(":\t") << strValue << _T("\n");
									...
									case mmioFOURCC('I', 'A', 'R', 'T'):
										if (bFullInfo && mi->strInfo.m_hWnd && !strValue.IsEmpty())
											mi->strInfo << _T("   ") << GetResString(_T("AUTHOR")) << _T(":\t") << strValue << _T("\n");
									...
									case mmioFOURCC('I', 'C', 'M', 'T'):
										if (bFullInfo && mi->strInfo.m_hWnd && !strValue.IsEmpty())
											mi->strInfo << _T("   ") << GetResString(_T("COMMENT")) << _T(":\t") << strValue << _T("\n");
										break;
									case mmioFOURCC('I', 'C', 'R', 'D'):
										if (bFullInfo && mi->strInfo.m_hWnd && !strValue.IsEmpty())
											mi->strInfo << _T("   ") << GetResString(_T("DATE")) << _T(":\t") << strValue << _T("\n");
										break;
...
bool GetRMHeaders(LPCTSTR pszFileName, SMediaInfo *mi, bool &rbIsRM, bool bFullInfo)
{
	...
	if (!file.OpenLongPath(pszFileName, CFile::modeRead | CFile::osSequentialScan | CFile::typeBinary))
		return false;
			...
			|| !aFileProps.IsEmpty()))
	{
		...
		if (nFileBitrate) {
			CString strBitrate;
			strBitrate.Format(_T("%u %s"), (UINT)((nFileBitrate + 500) / 1000), (LPCTSTR)GetResString(_T("KBITSSEC")));
			mi->strInfo << _T("   ") << GetResString(_T("BITRATE")) << _T(":\t") << strBitrate << _T("\n");
		}
		if (!mi->strTitle.IsEmpty())
			mi->strInfo << _T("   ") << GetResString(_T("TITLE")) << _T(":\t") << mi->strTitle << _T("\n");
		if (!mi->strAuthor.IsEmpty())
			mi->strInfo << _T("   ") << GetResString(_T("AUTHOR")) << _T(":\t") << mi->strAuthor << _T("\n");
		if (!strCopyright.IsEmpty())
			mi->strInfo << _T("   ") << _T("Copyright") << _T(":\t") << strCopyright << _T("\n");
		if (!strComment.IsEmpty())
			mi->strInfo << _T("   ") << GetResString(_T("COMMENT")) << _T(":\t") << strComment << _T("\n");
...
public:
	...
	{
		HANDLE hFile = ::CreateFile(PreparePathForWin32LongPath(pszFileName), dwDesiredAccess, dwShareMode, NULL, dwCreationDisposition, FILE_ATTRIBUTE_NORMAL, NULL);
							...
							if (pIWMHeaderInfo->GetAttributeByIndex(wAttr, &wStream, wszName, &wNameSize, &attrType, NULL, &wDataSize) == S_OK) {
								if (attrType == WMT_TYPE_STRING) {
									...
									if (GetAttribute(pIWMHeaderInfo, wStream, wszName, bValue) && bValue) {
										...
										mi->strInfo << _T("   ") << strName << _T(":\t") << GetResString(_T("YES")) << _T("\n");
										if (bWarnInRed)
				...
				while (wStream < 0x7F) {
							...
							if (pStreamTypeInfo->guidMajorType == WMMEDIATYPE_Video) {
									...
									if (pVideoInfo->bmiHeader.biSize >= sizeof pVideoInfo->bmiHeader) {
										if (mi->iVideoStreams == 1) {
											...
											if (!mi->strInfo.IsEmpty())
												mi->strInfo << _T("\n");
											mi->strInfo.SetSelectionCharFormat(mi->strInfo.m_cfBold);
											mi->strInfo << GetResString(_T("VIDEO")) << _T(" #") << mi->iVideoStreams << _T("\n");
											...
											if (pVideoInfo->AvgTimePerFrame) {
												...
												mi->strInfo << _T("   ") << GetResString(_T("FPS")) << _T(":\t") << fFrameRate << ("\n");
											}
										}
									}
								}
									...
									&& pStreamTypeInfo->cbFormat >= sizeof(WAVEFORMATEX))
								{
									...
									if (mi->iAudioStreams == 1) {
										...
										mi->OutputFileName();
										mi->strInfo.SetSelectionCharFormat(mi->strInfo.m_cfBold);
										mi->strInfo << GetResString(_T("AUDIO")) << _T(" #") << mi->iAudioStreams << _T("\n");
										mi->strInfo << _T("   ") << GetResString(_T("CODEC")) << _T(":\t") << GetAudioFormatName(pWaveFormatEx->wFormatTag) << _T("\n");
										...
										if (pWaveFormatEx->nAvgBytesPerSec) {
											...
											if (pWaveFormatEx->nAvgBytesPerSec == _UI32_MAX)
												...
												strBitrate.Format(_T("%u %s"), (UINT)((pWaveFormatEx->nAvgBytesPerSec * 8 + 500) / 1000), (LPCTSTR)GetResString(_T("KBITSSEC")));
											mi->strInfo << _T("   ") << GetResString(_T("BITRATE")) << _T(":\t") << strBitrate << _T("\n");
										}
										...
										if (pWaveFormatEx->nSamplesPerSec)
											mi->strInfo << _T("   ") << GetResString(_T("SAMPLERATE")) << _T(":\t") << pWaveFormatEx->nSamplesPerSec / 1000.0 << _T(" kHz\n");
								...
								if (GetAttributeEx(pIWMHeaderInfo3, wStream, g_wszWMPeakBitrate, dwValue) && dwValue != 0)
									mi->strInfo << _T("   ") << GetResString(_T("BITRATE")) << _T(":\t") << (UINT)((dwValue + 500) / 1000) << _T(" kbit/s\n");
							}
						}
					}
					...
					if (wStream > 0 && !bHaveStreamInfo) {
						...
						if (GetAttribute(pIWMHeaderInfo, wStream, g_wszDeviceConformanceTemplate, strDevTempl)) {
							...
							strStreamType = GetResString(strStreamType);
						}
						...
						if (!strStreamType.IsEmpty()) {
							...
							if (streamCodecType == WMT_CODECINFO_VIDEO) {
								...
								if (mi->iVideoStreams == 1) {
									...
									if (bFullInfo && mi->strInfo.m_hWnd) {
										...
										if (!strCodecName.IsEmpty())
											mi->strInfo << _T("   ") << GetResString(_T("SW_NAME")) << _T(":\t") << strCodecName << _T("\n");
										if (!strCodecDesc.IsEmpty())
											mi->strInfo << _T("   ") << GetResString(_T("DESCRIPTION")) << _T(":\t") << strCodecDesc << _T("\n");
									...
									mi->strInfo.SetSelectionCharFormat(mi->strInfo.m_cfBold);
									mi->strInfo << GetResString(_T("VIDEO")) << _T(" #") << mi->iVideoStreams << _T("\n");
									mi->strInfo << _T("   ") << GetResString(_T("CODEC")) << _T(":\t") << GetVideoFormatName(dwCodecId) << _T("\n");
									if (!strCodecName.IsEmpty())
										mi->strInfo << _T("   ") << GetResString(_T("SW_NAME")) << _T(":\t") << strCodecName << _T("\n");
									if (!strCodecDesc.IsEmpty())
										mi->strInfo << _T("   ") << GetResString(_T("DESCRIPTION")) << _T(":\t") << strCodecDesc << _T("\n");
									if (!strStreamInfo.IsEmpty())
										mi->strInfo << _T("   Device Conformance:\t") << strStreamInfo << _T("\n");
									if (dwBitrate)
										mi->strInfo << _T("   ") << GetResString(_T("BITRATE")) << _T(":\t") << (UINT)((dwBitrate + 500) / 1000) << _T(" Kbit/s\n");
								}
								...
								if (mi->iAudioStreams == 1) {
									...
									mi->strInfo.SetSelectionCharFormat(mi->strInfo.m_cfBold);
									mi->strInfo << GetResString(_T("AUDIO")) << _T(" #") << mi->iAudioStreams << _T("\n");
									mi->strInfo << _T("   ") << GetResString(_T("CODEC")) << _T(":\t") << GetAudioFormatName((WORD)dwCodecId) << _T("\n");
									if (!strCodecName.IsEmpty())
										mi->strInfo << _T("   ") << GetResString(_T("SW_NAME")) << _T(":\t") << strCodecName << _T("\n");
									if (!strCodecDesc.IsEmpty())
										mi->strInfo << _T("   ") << GetResString(_T("DESCRIPTION")) << _T(":\t") << strCodecDesc << _T("\n");
													...
													if (!bAddedBakedAudioStream) {
														...
														if (bFullInfo && mi->strInfo.m_hWnd && (!strName.IsEmpty() || !strDesc.IsEmpty())) {
															...
															if (!mi->strInfo.IsEmpty())
																mi->strInfo << _T("\n");
															mi->strInfo.SetSelectionCharFormat(mi->strInfo.m_cfBold);
															mi->strInfo << GetResString(_T("AUDIO")) << _T("\n");
															if (!strName.IsEmpty())
																mi->strInfo << _T("   ") << GetResString(_T("SW_NAME")) << _T(":\t") << strName << _T("\n");
															if (!strDesc.IsEmpty())
																mi->strInfo << _T("   ") << GetResString(_T("DESCRIPTION")) << _T(":\t") << strDesc << _T("\n");
														}
													} else
														ASSERT(0);
													...
													if (!bAddedBakedVideoStream) {
														...
														if (bFullInfo && mi->strInfo.m_hWnd && (!strName.IsEmpty() || !strDesc.IsEmpty())) {
															...
															if (!mi->strInfo.IsEmpty())
																mi->strInfo << _T("\n");
															mi->strInfo.SetSelectionCharFormat(mi->strInfo.m_cfBold);
															mi->strInfo << GetResString(_T("VIDEO")) << _T("\n");
															if (!strName.IsEmpty())
																mi->strInfo << _T("   ") << GetResString(_T("SW_NAME")) << _T(":\t") << strName << _T("\n");
															if (!strDesc.IsEmpty())
																mi->strInfo << _T("   ") << GetResString(_T("DESCRIPTION")) << _T(":\t") << strDesc << _T("\n");
